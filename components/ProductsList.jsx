    ...
    <div className="w-full bg-gradient-to-b from-gray-50 to-white py-12">
      <div className="w-full md:w-[90%] mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-blue-100 text-red-600 px-4 py-2 rounded-full text-sm font-semibold mb-3">
            <TrendingUp size={16} />
            Trending Products
          </div>
        ...
        <div className="text-center mt-10">
          <Link href="/shop" className="px-8 py-3 bg-red-600 text-white rounded-full font-semibold hover:shadow-xl transition-all transform hover:scale-105">
            View All Products →
          </Link>
        </div>
      </div>
